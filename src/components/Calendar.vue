  ...
  <main>
    <div class="grid calendar-heading">
      ...
      <div class="container buttons">
        <div class="grid">
        <button id='btnPrev' class="prev-month col col-d-offset-2 col-d-1 col-m-1" @click="clickPrevCalendar"></button>
        <button id='btnNext' class="next-month col col-d-offset-6 col-d-1 col-m-1 col-m-offset-2" @click="clickNextCalendar"></button>
        </div>
      </div>
      <!-- <div class="grid">
    ...
    <table class="grid">
      <caption>
        <h3 id='currentDate' class="year"> {{ calHeader }} </h3>
        <button class="btn-today" @click="setCurrentMonth">today</button>
      </caption>
      <colgroup>
        <col width="100">
        <col width="100">
...
export default {
  ...
  methods: {
    ...
    clickTargetDate(target_date) {
      ...
      console.log('targetDate',target_date);
